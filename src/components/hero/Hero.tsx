...
function Hero() {
  return (
    <section className='pt-16 wrapper grid lg:grid-cols-2 gap-20 lg:gap-4 grid-rows-2 lg:grid-rows-1  min-h-[70vh]'>
      <div className='grid grid-cols-1 content-center justify-items-center lg:pl-24 lg:justify-items-start  gap-6'>
      ...
      <div className='relative'>
        <Image src='/images/hero_nft.png' alt='NFT Image' fill sizes='(max-width: 768px) 100vw, (max-width: 1200px) 50vw' className='object-contain' priority />
        <Image className='absolute top-[55%] right-[65%]' width={33} height={33} sizes='33vw' src='/shapes/shape1.png' alt='shape' priority />
        <Image className='absolute bottom-0 top-[35%] right-[40%]' width={33} height={33} sizes='33vw' src='/shapes/shape1.png' alt='shape' priority />
        <Image className='absolute right-[30%]' width={36} height={36} sizes='33vw' src='/shapes/shape2.png' alt='shape' priority />
